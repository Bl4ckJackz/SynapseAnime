...
const NAV_ITEMS = [
  ...
  { href: "/anime", label: "Anime", icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" },
  ...
  { href: "/movies-tv", label: "Movies & TV", icon: "M7 4v16M17 4v16M3 8h4m10 0h4M3 12h18M3 16h4m10 0h4M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z" },
  ...
  { href: "/downloads", label: "Downloads", icon: "M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" },
  ...
  { href: "/subscribe", label: "Premium", icon: "M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" },
];
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex lg:w-56 lg:flex-col lg:border-r lg:border-[var(--color-border)] lg:bg-[var(--color-bg)]">
