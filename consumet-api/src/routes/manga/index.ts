...
const routes = async (fastify: FastifyInstance, options: RegisterOptions) => {
  ...
  await fastify.register(mangaworld, { prefix: '/mangaworld' });
  await fastify.register(mangakatana, { prefix: '/mangakatana' });
  await fastify.register(mangasee, { prefix: '/mangasee' });
