...
// Transform functions
export function transformMangaHookList(response: MangaHookListResponse, page: number): MangaHookMangaListDto {
    return {
        ...
        filters: {
            ...
            categories: response.metaData.category.map(c => ({ id: c.id, label: c.type })),
        },
    };
}

export function transformMangaHookDetail(manga: MangaHookMangaDetail): MangaHookMangaDetailDto {
    return {
        id: manga.id,
        title: manga.title,
        description: manga.description,
...
export function transformMangaHookChapter(chapter: MangaHookChapterImages): MangaHookChapterDto {
    return {
