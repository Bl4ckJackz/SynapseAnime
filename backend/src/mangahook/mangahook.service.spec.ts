...
describe('MangaHookService', () => {
        ...
        const module: TestingModule = await Test.createTestingModule({
            providers: [
                MangaHookService,
                {
                    ...
                    useValue: {
                        get: jest.fn().mockReturnValue('https://mangahook-api.vercel.app/api'),
                    },
                },
                {
                ...
                },
                {
                    ...
                    useValue: {
                        execute: jest.fn().mockImplementation((name, operation, fallback) => {
                            try {
                                return operation();
                            } catch (e) {
    ...
    describe('getMangaList', () => {
        ...
        it('should fetch from API if not cached', async () => {
            ...
            expect(mockAxiosInstance.get).toHaveBeenCalledWith(expect.stringContaining('/mangaList'));
    ...
    describe('executeRequest', () => {
        ...
        it('should handle API errors gracefully', async () => {
            ...
            await expect(service.getMangaList({})).rejects.toThrow('Manga Hook API error');
        });
    });
